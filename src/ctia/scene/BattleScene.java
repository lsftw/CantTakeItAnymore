...
import ctia.display.FadeMessage;
import ctia.display.MessageDisplay;
import ctia.display.PermanentMessage;
import ctia.display.TextMessage;
import ctia.entity.Player;
import ctia.scene.ShipSelectScene.Ship;
...
public class BattleScene extends SGuiScene implements KeyListener, LevelHandler {
	...
	protected void initGame() { // call after being added to a JFrame
		...
		int y = Entity.getMaxY() - 50;
//			player = new DebugShip(zone, x, y);
		player.setPy(Entity.getMaxY() - player.getSy());
		getFrame().setTitle("Cant Take It Anymore - Piloting the " + player);
