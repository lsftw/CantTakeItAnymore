...
import flyingpeople.display.AbilityMessage;
...
public abstract class Flyer {
	...
	public Flyer(Zone container, double xpos, double ypos) {
	...
	public boolean collidesWith(Flyer other) { // rectangle collision check
	...
	public boolean isActive() {
		return container.hasFlyer(this);
	}
