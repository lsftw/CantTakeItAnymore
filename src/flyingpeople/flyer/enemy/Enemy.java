...
public abstract class Enemy extends Being {
	...
	protected void hit(Being collided) { // collide with another flyer, damaging both fliers
		this.hitBy(collided, this.collisionDamage);
		collided.hitBy(this, collided.getCollisionDamage());
	}
	public void hitBy(Flyer attacker, int damage) { // for giving points on destruction
