...
import flyingpeople.scene.MainMenuScene;

// runs the flying people game as a java swing application
@SuppressWarnings("serial")
public class FPSwingRunner extends JFrame implements SceneHandler {
	...
	public static void main(String[] args) {
		FPSwingRunner frame = new FPSwingRunner();
